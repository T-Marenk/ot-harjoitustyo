...
class AddIncomeView:
    ...
    def _initialize(self):
        ...
        self._income_name.grid(row=0, column=1, sticky=(constants.W, constants.E), padx=5, pady=5)
        label_amount.grid(row=1, column=0, padx=5, pady=5)
        self._income_amount.grid(row=1, column=1, sticky=(constants.W, constants.E), padx=5, pady=5)
        add_income.grid(row=2, column=0, sticky=(constants.W, constants.E), padx=5, pady=5)
