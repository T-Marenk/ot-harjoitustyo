...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kortin_saldo_edullinen(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        # Kortin saldo on 2.5 euroa
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_voi_syoda_maukkaasti_saldo_on_4_euroa(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti.lataa_rahaa(2)
        #Kortin saldo on 4 euroa
        self.kortti.syo_maukkaasti()
